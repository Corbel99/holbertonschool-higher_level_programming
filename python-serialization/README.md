...
* [Real Python Serialization](https://intranet.hbtn.io/rltoken/dCh_kqSXRNy5zjTznUki6w)
* [Real Python: Working With JSON Data in Python](https://intranet.hbtn.io/rltoken/OD6iwbpQ_i9HPoAGXJEGLQ)
* [Python's pickle documentation](https://intranet.hbtn.io/rltoken/IibAgnq4_yiGI9w0uqIxxw)
* [Corey Schafer on Pickle](https://intranet.hbtn.io/rltoken/8Kk_654pW2ZQPuiRNgWGCA)
* [CSV to JSON in Python](https://intranet.hbtn.io/rltoken/ZSsuXXF6b30nGMDUveJYkw)
* [Python XML ElementTree Guide](https://intranet.hbtn.io/rltoken/fvfT2Y6UVND9sfIgzqIe4w)
* [Socket Programming Guide](https://intranet.hbtn.io/rltoken/F-DQ6YzeR9vV0QWWhlOpFg)
